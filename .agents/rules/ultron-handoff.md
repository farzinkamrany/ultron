...
### قانون Reset و بهترین استراتژی نقد کردن (The Reset Strategy):
- استراتژی بهینه: **هر ۶ ماه کل سود را نقد کن و حساب را دقیقاً روی $1,000 تا $5,000 ریست کن.**
- **دلیل:** وقتی سرمایه ربات کوچک نگه داشته شود (زیر ۲۰ هزار دلار)، سیستم در پله اول مدیریت ریسک قرار می‌گیرد (لوریج ۱۰ و ریسک ۰.۵٪). این یعنی شما تمام **ضرایب نجومی و وحشتناک بالا** (مانند ۴۰۰x و ۱۰۰۰x) را در ۶ ماه بعدی دریافت می‌کنید.
- **تضمین امنیتی (Max Drawdown 22%):** طبق بک‌تست‌ها، اگر از ۱۰۰۰ دلار استارت بزنید، افت سرمایه شما (Drawdown) از کل دارایی ساخته شده هرگز از ۲۲٪ تجاوز نمی‌کند.
- **نتیجه:** "سرمایه ربات را همیشه گرسنه و سبک نگه دار." اگر اجازه دهید سرمایه به میلیون‌ها دلار برسد، به دلیل محدودیت‌های حجم صرافی (Slippage/Cap) ربات مجبور به کاهش لوریج شده و سوددهی مرکب آن کند می‌شود.
