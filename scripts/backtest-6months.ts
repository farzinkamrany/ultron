...
async function runOptimization() {
  console.log("🚀 Starting 6-Month Backtest for BTC/USDT on 15m (Hyperliquid Fees) with Circuit Breaker...");
  ...
  try {
    ...
    console.log(`\n================================`);
    console.log(`[FINAL RESULT] ${symbol} ${tf} (6 Months, CB ENABLED)`);
    console.log(`Total Trades: ${totalSignals}`);
    console.log(`Win Rate:     ${winRate.toFixed(2)}%`);
    console.log(`Max Drawdown: ${(maxDrawdown * 100).toFixed(2)}%`);
    console.log(`Total Fees:   $${totalFees.toFixed(2)}`);
    console.log(`CB Paused:    ${cbTriggeredCount} candles`);
